...
void System::_frameBegin() noexcept {
	...
	// thank God for multiline cursor
	{
		...
		FRAME_BEGIN_KEYBOARD(world1)
		FRAME_BEGIN_KEYBOARD(world2)
		FRAME_BEGIN_KEYBOARD(scrollLock)
		FRAME_BEGIN_KEYBOARD(pause)
		FRAME_BEGIN_KEYBOARD(numEqual)
...
void System::_frameEnd() noexcept {
	{
		...
		FRAME_END_KEYBOARD(world1)
		FRAME_END_KEYBOARD(world2)
		FRAME_END_KEYBOARD(scrollLock)
		FRAME_END_KEYBOARD(pause)
		FRAME_END_KEYBOARD(numEqual)
