...
//template<class... Ts>
//template<size_t Pos>
//struct type_string<Ts...>::iterator {
//	using parent = type_string<Ts...>;
...
//	using next = next_t;
//	using prev = std::conditional_t<valid, std::conditional_t<(pos == 0), iterator, iterator<pos - 1>>, typename parent::iterator<length - 1>>;
//
...
//
//template<class... Ts>
//struct type_string<Ts...>::begin_s {
//	using type = iterator<0>;
//};
//
//template<class... Ts>
//struct type_string<Ts...>::end_s {
