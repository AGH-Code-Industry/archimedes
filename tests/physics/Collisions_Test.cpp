...
protected:
    ...
    ecs::Entity createOBB(const math::float3& pos, const math::Quat& rot,
                                    const math::float3& scale, const phy::OBB& obb) {
        auto e = _domain->newEntity();
        _domain->addComponent<TransformComponent>(e, 
            { pos, rot, scale }
        );
        _domain->addComponent<phy::ColliderComponent>(e,
    ...
    ecs::Entity createTriangle(const math::float3& pos, const math::Quat& rot,
                                        const math::float3& scale, const phy::Triangle& tri) {
        auto e = _domain->newEntity();
        _domain->addComponent<TransformComponent>(e, 
            { pos, rot, scale }
        );
    ...
    ecs::Entity createCircle(const math::float3& pos, const math::Quat& rot,
                                        const math::float3& scale, const phy::Circle& circle) {
        auto e = _domain->newEntity();
        _domain->addComponent<TransformComponent>(e, 
            { pos, rot, scale }
        );
    ...
    ecs::Entity createHorizontalLine(const math::float3& pos, const math::Quat& rot,
                                    const math::float3& scale, const phy::HorizontalLine& line) {
        auto e = _domain->newEntity();
        _domain->addComponent<TransformComponent>(e, 
            { pos, rot, scale }
        );
    ...
    ecs::Entity createVerticalLine(const math::float3& pos, const math::Quat& rot,
                                    const math::float3& scale, const phy::VerticalLine& line) {
        auto e = _domain->newEntity();
        _domain->addComponent<TransformComponent>(e, 
            { pos, rot, scale }
        );
...
TEST_F(CollisionTest, OBBvsOBB_Collision) {
    phy::OBB obb{ {-0.25f, 0.25f, 0.f}, {0.25f, -0.25f, 0.f}, 0.f };
...
TEST_F(CollisionTest, OBBvsOBB_RotatedCollision) {
    phy::OBB obb1{ {-0.25f,0.25f,0}, {0.25f,-0.25f,0}, 0.f };
    phy::OBB obb2{ {-0.25f,0.25f,0}, {0.25f,-0.25f,0}, 0.785398f }; // ~45 deg
...
TEST_F(CollisionTest, TriangleVsTriangle_NoCollision) {
    phy::Triangle tri{ {0,0.5f,0}, {-0.5f,-0.5f,0}, {0.5f,-0.5f,0} };
...
TEST_F(CollisionTest, TriangleVsOBB_Collision) {
    phy::Triangle tri{ {0,0.5f,0}, {-0.5f,-0.5f,0}, {0.5f,-0.5f,0} };
    phy::OBB obb{ {-0.25f,0.25f,0}, {0.25f,-0.25f,0}, 0.f };
...
TEST_F(CollisionTest, HorizontalLineVsTriangle_Crossing) {
    phy::HorizontalLine line{ 0.0f };
    phy::Triangle tri{ {0,1,0}, {-1,-1,0}, {1,-1,0} };
...
TEST_F(CollisionTest, HorizontalLineVsTriangle_Above) {
    phy::HorizontalLine line{ 0.0f };
    phy::Triangle tri{ {0,2,0}, {-1,1,0}, {1,1,0} };
...
TEST_F(CollisionTest, VerticalLineVsTriangle_Crossing) {
    ...
    phy::Triangle tri{ {1,0,0}, {-1,-1,0}, {-1,1,0} };
...
TEST_F(CollisionTest, VerticalLineVsTriangle_NoCollision) {
    phy::VerticalLine line{ 0.0f };
    phy::Triangle tri{ {2,0,0}, {3,1,0}, {3,-1,0} };
...
TEST_F(CollisionTest, HorizontalLineVsOBB_Crossing) {
    phy::HorizontalLine line{ 0.0f };
    phy::OBB obb{ {-0.5f,0.5f,0}, {0.5f,-0.5f,0}, 0.f };
