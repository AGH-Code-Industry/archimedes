...
TEST(IPv4, Increment) {
	...
	to_work.emplace_back("0.0.0.254");			equals.emplace_back("0.0.0.255");
	to_work.emplace_back("0.0.0.255");			equals.emplace_back("0.0.1.0");
	to_work.emplace_back("0.0.255.255");		equals.emplace_back("0.1.0.0");
	to_work.emplace_back("0.255.255.255");		equals.emplace_back("1.0.0.0");
	to_work.emplace_back("255.255.255.255");	equals.emplace_back("0.0.0.0");
...
TEST(IPv4, Decrement) {
	std::vector<arch::net::IPv4> to_work;
	std::vector<arch::net::IPv4> equals;
	equals.emplace_back("0.0.0.254");		to_work.emplace_back("0.0.0.255");
	equals.emplace_back("0.0.0.255");		to_work.emplace_back("0.0.1.0");
	equals.emplace_back("0.0.255.255");		to_work.emplace_back("0.1.0.0");
	equals.emplace_back("0.255.255.255");	to_work.emplace_back("1.0.0.0");
	equals.emplace_back("255.255.255.255");	to_work.emplace_back("0.0.0.0");
